...
public class DecodificadorMensajes
{
     ...
     */
    public Mensaje decodificarMensaje(Mensaje mensajeExistente) 
    {
      ...
      if (mensajeExistente == null) {
       ...
       // Obtener las líneas del mensaje encriptado
        ArrayList<String> lineasEncriptadas = mensajeExistente.getLineas();   
        ...
        for (String lineaEncriptada : lineasEncriptadas) {
            ...
            for (int i = 0; i < lineaEncriptada.length(); i++) {
                ...
                if (Character.isLetter(c)) {
                    ...
                    c = (char) ((c - base - clave + 127) % 127 + base);
                }
        ...
        mensajeExistente.asignarLineas(lineasDesencriptadas);
        return mensajeExistente;
      }
     ...
     */
    public Mensaje obtenerMensajeDecodificado(Mensaje mensajeExistente) {
        if (mensajeExistente == null)
